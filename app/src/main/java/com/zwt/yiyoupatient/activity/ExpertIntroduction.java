...
public class ExpertIntroduction extends BaseActivity {
    ...
    protected void initListener() {
        ...
        orderlv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                openActivity(DoctorMessageActivity.class);
            }
        });
    }
    ...
    private void initDoctor() {
        for (int i = 0; i < 10; i++) {
            Doctor doctor = new Doctor(R.drawable.viewpager4, "王医师", "主治科目：内科", "医师认证等级：高职职称");
            doctors.add(doctor);
        }
    }
    ...
    private void onRefresh(View view, String showText) {
        ...
        Toast.makeText(ExpertIntroduction.this, showText, Toast.LENGTH_SHORT).show();
