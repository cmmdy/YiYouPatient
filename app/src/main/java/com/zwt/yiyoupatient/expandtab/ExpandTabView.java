...
public class ExpandTabView extends LinearLayout implements OnDismissListener {
    ...
    public void setValue(ArrayList<String> textArray, ArrayList<View> viewArray) {
        ...
        for (int i = 0; i < viewArray.size(); i++) {
            ...
            int maxHeight = (int) (displayHeight * 0.45);
    ...
    private void showPopup(int position) {
        ...
        popupWindow.showAtLocation(this, Gravity.NO_GRAVITY, 0, location[1] + this.getHeight() + 0);
    }
    ...
    private void init(Context context) {
        mContext = context;
        displayWidth = (int) HomeActivity.gethw.getWIDTH();
        displayHeight = (int) HomeActivity.gethw.getHEIGHT();
